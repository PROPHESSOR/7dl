...
label alt_day0_start_h:
    ...
    "И узнал я об этом, лишь, когда вылил его к первому в сковородку."
    ...
    stop music fadeout 3
    "И как обычно, в моменты вынужденного безделья мало-помалу начал углубляться в воспоминания."
    window hide
    $ volume(1.0, 'music')
    play music music_7dl["seven_summer_days"] fadein 3
    $ renpy.pause(3)
