...
label alt_day7_us_7dl_start:
    ...
    $ persistent.sprite_time = "prolog"
    $ prolog_time()
    if (persistent.us_7dl_tran_un or persistent.us_7dl_tran_mi) and persistent.us_px_good and (alt_day4_neu_us_pixies != 0) and alt_day6_us_7dl_tr:
