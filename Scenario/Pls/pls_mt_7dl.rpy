...
label alt_day7_mt_7dl_start:
    ...
    if alt_day7_mt_7dl_pt == 1:
        ...
        pause(1)
        if (mt_pt >= 15) and (alt_day2_date == 'mt') and alt_day5_neu_mt_diary and alt_day4_neu_mt_diary:
        ...
        $ persistent.sprite_time = "day"
        $ day_time()
        $ alt_chapter(7, u"Ольга. Странные люди")
        call alt_day7_mt_7dl_sept
    else:
        ...
        pause(1)
        if (mt_pt >= 13) and (alt_day2_date == 'mt') and (alt_day3_dancing == 5) and alt_day4_neu_mt_fire:
