...
screen bgs_7dl_9:
    ...
    if renpy.seen_image("bg int_wagon_day_7dl"):
        ...
        add get_image_7dl("gui/gallery/locked_img/" + renpy.random.choice(locked_img_7dl)) xalign 0.5 yalign 0.15
    if renpy.seen_image("bg ext_genda_7dl"):
        imagebutton:
            auto get_image_7dl("gui/gallery/bgs/ext_genda_7dl_%s.png") xalign 0.8 yalign 0.15 
            action [Hide(gallery_mode_7dl + "_7dl_" + str(page_7dl), transition=Dissolve(0.2)), Hide("gallery_bw_7dl", transition=Dissolve(0.2)), Hide("gallery_fw_7dl", transition=Dissolve(0.2)), Hide("gallery_exit_7dl", transition=Dissolve(0.2)), SetVariable("show_image_7dl", "bg ext_genda_7dl"), SetVariable("show_image2_7dl", "bg ext_genda_clean_7dl"), SetVariable("show_image3_7dl", ""), SetVariable("show_image4_7dl", ""), Jump("show_img_7dl")] 
    else:
        add get_image_7dl("gui/gallery/locked_img/" + renpy.random.choice(locked_img_7dl)) xalign 0.8 yalign 0.15
    if renpy.seen_image("bg ext_admins_day_7dl"):
        imagebutton:
            auto get_image_7dl("gui/gallery/bgs/ext_admins_day_7dl_%s.png") xalign 0.2 yalign 0.93 
    ...
    if renpy.seen_image("bg ext_valun_day_7dl"):
        imagebutton:
            ...
            action [Hide(gallery_mode_7dl + "_7dl_" + str(page_7dl), transition=Dissolve(0.2)), Hide("gallery_bw_7dl", transition=Dissolve(0.2)), Hide("gallery_fw_7dl", transition=Dissolve(0.2)), Hide("gallery_exit_7dl", transition=Dissolve(0.2)), SetVariable("show_image_7dl", "bg ext_valun_day_7dl"), SetVariable("show_image2_7dl", "bg ext_valun_sunset_7dl"), SetVariable("show_image3_7dl", ""), SetVariable("show_image4_7dl", ""), Jump("show_img_7dl")] 
    else:
        add get_image_7dl("gui/gallery/locked_img/" + renpy.random.choice(locked_img_7dl)) xalign 0.5 yalign 0.93
    if renpy.seen_image("bg int_semen_room_window_day_7dl"):
        imagebutton:
            auto get_image_7dl("gui/gallery/bgs/int_semen_room_window_day_7dl_%s.png") xalign 0.8 yalign 0.93 
...
screen arts_7dl_11:
    ...
    textbutton next_page_7dl:
        ...
        xalign 0.95
        yalign 0.95
    if renpy.seen_image("cg d7_mi_sparkle_7dl"):
        imagebutton:
        ...
        add get_image_7dl("gui/gallery/locked_img/" + renpy.random.choice(locked_img_7dl)) xalign 0.19 yalign 0.15 
    if renpy.seen_image("cg d5_sl_piano_1_7dl"):
        imagebutton:
        ...
        add get_image_7dl("gui/gallery/locked_img/" + renpy.random.choice(locked_img_7dl)) xalign 0.5 yalign 0.15 
    if renpy.seen_image("cg d7_me_loki_7dl"):
        imagebutton:
            auto get_image_7dl("gui/gallery/arts/d7_me_loki_7dl_%s.png") xalign 0.8 yalign 0.15 
            action [Hide(gallery_mode_7dl + "_7dl_" + str(page_7dl), transition=Dissolve(0.2)), Hide("gallery_bw_7dl", transition=Dissolve(0.2)), Hide("gallery_fw_7dl", transition=Dissolve(0.2)), Hide("gallery_exit_7dl", transition=Dissolve(0.2)), SetVariable("show_image_7dl", "cg d7_me_loki_7dl"), SetVariable("show_image2_7dl", "cg d7_me_loki2_7dl"), SetVariable("show_image3_7dl", ""), SetVariable("show_image4_7dl", ""), Jump("show_img_7dl")] 
    else:
        add get_image_7dl("gui/gallery/locked_img/" + renpy.random.choice(locked_img_7dl)) xalign 0.8 yalign 0.15 
    if renpy.seen_image("cg d6_us_ghost_7dl"):
        imagebutton:
