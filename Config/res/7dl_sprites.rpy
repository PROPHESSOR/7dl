...
init 9999 python:
    ...
    alt_clothes_dict = {
                    ...
                    'el':{'1':['pioneer', 'uniform'],
                          '2':['pioneer', 'uniform'],
                          '3':['pioneer', 'uniform']},
                    'ka':{'1':['casual','pioneer','swim','body'],
                          '2':['casual','pioneer','swim','body'],
                          '3':['casual','pioneer','swim','body']},
                    'ln':{'1':['dress','pioneer','body'],
                          '2':['dress','pioneer','body'],
                          '3':['dress','pioneer','body']},
                    'mi':{'1':['casual','dress','pioneer','pioneer_transp','swim','voca','body'],
                          '2':['casual','dress','pioneer','pioneer_transp','swim','voca','body'],
                          '3':['casual','dress','pioneer','pioneer_transp','swim','voca','body']},
                    'mt':{'1':['dress','pioneer','sport','swim','swim2', 'uniform','body'],
                          '2':['dress','pioneer','sport','swim','swim2','uniform','body'],
                          '3':['dress','pioneer','sport','swim2','uniform','body']},
                    'mz':{'1':['pioneer'],
                          '2':['pioneer'],
                          '3':['pioneer']},
                    'sak':{'1':['suit'],
                    ...
                    'sh':{'1':['uniform'],
                          '2':['uniform'],
                          '3':['uniform']},
                    'sl':{'1':['casual','dress','pioneer','pioneer2','sport','suit','swim','uniform','body'],
                          '2':['casual','dress','pioneer','pioneer2','sport','suit','swim','body'],
                          '3':['casual','dress','pioneer','pioneer2','sport','suit','swim','voca','body'],
                          '4':['casual','dress','pioneer','pioneer2','sport','suit','swim','body'],
                          '5':['25']},
                    'tn':{'1':['pioneer']},
                        ...
                        for clothes in alt_clothes_dict[who][pose]:
                            for emo in alt_emo_dict[who][pose]:
                                for acc in alt_acc_dict[who][pose]:
                                    if (who == 'sl') and (body == 'body') and (clothes == 'suit'):
                                        pass
                                    elif body != '':
                                        if 'body2' in body:
                                            who_num = who + '2'
...
#Славя 1
    ...
    image sl tr1 upset = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/sl/sl_3_body.png'), (0, 0), get_sprite_7dl('normal/sl/sl_3_casual.png'), (0, 0), get_sprite_7dl('normal/sl/sl_3_upset.png')),  im.matrix.opacity(0.8) )
    image sl tr1 smile = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/sl/sl_1_body.png'), (0, 0), get_sprite_7dl('normal/sl/sl_1_casual.png'), (0, 0), get_sprite_ori('normal/sl/sl_1_smile.png')),  im.matrix.opacity(0.8) )
    image sl tr2 upset = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/sl/sl_3_body.png'), (0, 0), get_sprite_7dl('normal/sl/sl_3_casual.png'), (0, 0), get_sprite_7dl('normal/sl/sl_3_upset.png')), im.matrix.tint(0.6, 0.6, 0.6)* im.matrix.opacity(0.6) )
    image sl tr2 smile = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/sl/sl_1_body.png'), (0, 0), get_sprite_7dl('normal/sl/sl_1_casual.png'), (0, 0), get_sprite_ori('normal/sl/sl_1_smile.png')), im.matrix.tint(0.6, 0.6, 0.6)* im.matrix.opacity(0.6) )
...
#ОД в зимней одёжке для гуда-рф
    image mt smile coat: 
        get_sprite_7dl("custom/mt_smile_coat_7dl.png") 
    image mt smile coat close: 
        get_sprite_7dl("custom/mt_smile_coat_close_7dl.png") 
    image mt normal coat: 
        get_sprite_7dl("custom/mt_normal_coat_7dl.png")
