...
label alt_day2_participate_fail:
    ...
    if alt_pe == 1:
        ...
        if alt_day2_dv_bet_approve:
            ...
            "Спасибо, кэп."
            th "Это обязательно орать тут на всю столовую, правда?"
...
label alt_day2_participate_win:
    ...
    if alt_pe == 1:
        ...
        th "Это вопрос индивидуального престижа. Я буду двигаться к финалу и раскатаю там всех с нулевым счётом!"
        dreamgirl "Надежды… Мечты… Фантазии…"
        th "Ты что, сомневаешься во мне?!"
        dreamgirl "Нет-нет-нет, ты что! Я в тебя верю! Я знаю твой потенциал."
        th "Вот видишь!"
...
label alt_day2_semifinal:
    ...
    if alt_day2_hf2 == 4:
        ...
        th "Спокойствие. Терпение — добродетель."
...
label alt_day2_final_win:
    ...
    if alt_day2_f1 == 1:
        ...
        mi "Дядя Боря-сенсей! Мы здесь!" # TODO: максимально унифицировать транскрипцию японской лексики.
